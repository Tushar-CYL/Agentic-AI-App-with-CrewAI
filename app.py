...
content = Agent(
    ...
    backstory="You're a skilled content writer specialized in creating engaging, "
              "accessible content from technical research. "
              "You work closely with the Senior Research Analyst and excel at maintaining the perfect balance between informative and entertaining writing, "
...
crew = Crew(
    agents = [research_analyst, content],
